---
date: "2025-06-14T20:23:58+07:00"
draft: true
...
```js
const person = { name: "Yanouk", age: 19 };
const updatedPerson = { ...person, age: 20 };
console.log(updatedPerson); // { name: "Yanouk", age: 20 }
```
...
```js
const person = { name: "Yanouk", age: 19, city: "Multan" };
const { name, age } = person;
console.log(name, age); // Yanouk 19
```
...
```jsx
const [user, setUser] = useState({ name: "Yanouk", age: 19 });
...
```jsx
<ChildComponent name="Yanouk" age={19} />
```
